...
import styles from "./SessionReplayVideo.module.css";

interface SessionReplayVideoProps {
...
export default function SessionReplayVideo({
  play,
  ...
  return (
    <video
      ...
      src="/videos/SessionReplay_Final.mp4"
      muted
      loop
      playsInline
      preload="metadata"
