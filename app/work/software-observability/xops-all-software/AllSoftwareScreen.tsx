...
export function utilizationStatus(percent: number): TagStatus {
  if (percent >= 85) return "success";
  if (percent >= 75) return "warning";
  return "danger";
}

export function utilizationLabel(percent: number): string {
...
export const utilizationTooltip: Omit<TooltipProps, "children" | "className"> = {
  title: "Utilization",
  description:
...
export const opportunityTooltip: Omit<TooltipProps, "children" | "className"> = {
  title: "Opportunity",
  description:
...
export const assignedTooltip: Omit<TooltipProps, "children" | "className"> = {
  title: "Assigned",
  description:
    "Purchased licenses designated to a specific employee, reserving the seat for their use.",
};

export const unassignedTooltip: Omit<TooltipProps, "children" | "className"> = {
  title: "Unassigned",
  description:
...
export const renewalTooltip: Omit<TooltipProps, "children" | "className"> = {
  title: "Renewal",
  description:
...
export const distributionTooltip: Omit<TooltipProps, "children" | "className"> = {
...
export const activeTooltip: Omit<TooltipProps, "children" | "className"> = {
  title: "Active",
  description:
    "Assigned licenses that have recorded user activity within the last 90 days, showing they are delivering value.",
};

export const inactiveTooltip: Omit<TooltipProps, "children" | "className"> = {
  title: "Inactive",
  description:
...
export function renewalStatus(days: number): TagStatus {
...
export const softwareColumns: Column<ProductSummary>[] = [
  {
    key: "name",
    label: "Software",
    width: 240,
