...
**Next session starts here:** (1) add a 16px border-radius to the live embed (`.heroEmbed > *` in `SectionIntroduction.module.css`) — confirm as explicit value before writing. (2) Continue "the layer experience of showing code" — name/spec not yet identified; ask user to clarify.
